    ...
    vlSelf->HighQualityAdder__DOT__GrayCell_io_outG 
        = (1U & (((IData)(vlSelf->HighQualityAdder__DOT__GrayCell_io_currentP) 
                 ...
                 | (((IData)(vlSelf->io_inputs_0) & (IData)(vlSelf->io_inputs_1)) 
                    >> 1U)));
    vlSelf->io_outs_0 = ((((IData)(vlSelf->HighQualityAdder__DOT__BlackCell_io_currentP) 
                          ...
                          << 3U) | ((((IData)(vlSelf->HighQualityAdder__DOT__Buffer_1_io_currentP) 
                                      ^ (IData)(vlSelf->HighQualityAdder__DOT__GrayCell_io_outG)) 
                                     << 2U) | ((((IData)(vlSelf->HighQualityAdder__DOT__GrayCell_io_currentP) 
                                                 ^ (IData)(vlSelf->HighQualityAdder__DOT__Buffer_io_currentG)) 
                                                << 1U) 
                                               | (1U 
...
void VHighQualityAdder___024root___eval_debug_assertions(VHighQualityAdder___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->io_inputs_1 & 0xf0U))) {
        Verilated::overWidthError("io_inputs_1");}
    if (VL_UNLIKELY((vlSelf->io_inputs_0 & 0xf0U))) {
        Verilated::overWidthError("io_inputs_0");}
}
#endif  // VL_DEBUG
